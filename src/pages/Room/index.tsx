...
export const Room = () => {
  ...
  const onLike = async (questionId: string, likeId: string | undefined) => {
    if (likeId) {
          ...
          {questions.map((question) => (
            ...
            >
              <button
                ...
                onClick={() => onLike(question.id, question.likeId)}
              >
                {question.likeCount ? <span>{question.likeCount}</span> : null}
